...
bool
KillLanderCrewSeq (uqm::COUNT numKilled, uqm::DWORD period)
{
	TimeCount TimeOut;
	uqm::COUNT i;
...
void
InitLander (uqm::BYTE LanderFlags)
{
	RECT r;
