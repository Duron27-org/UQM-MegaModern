...
extern void DrawShipPiece (FRAME ModuleFrame, uqm::COUNT which_piece, uqm::COUNT
		which_slot, bool DrawBluePrint);

extern uqm::COUNT WrapText (const uqm::CHAR_T *pStr, uqm::COUNT len, TEXT *tarray, uqm::SIZE
		field_width);
