...
static constexpr STAR_DESC StarmapArray[] =
	{
		...
		{{3416, 5437}, MAKE_STAR(DWARF_STAR, BLUE_BODY, -1), ZOQ_COLONY2_DEFINED, 2, 16},
		...
		{{3937, 5625}, MAKE_STAR(DWARF_STAR, ORANGE_BODY, -1), ZOQ_COLONY3_DEFINED, 2, 18},
...
#define VORTEX_SCALE 20
		{{(-12 * VORTEX_SCALE) + 5000, (-21 * VORTEX_SCALE) + 5000},
		 MAKE_STAR(DWARF_STAR, WHITE_BODY, -1),
		 0,
		 0,
		 133},
