...
#define SAVE_UNSELECTED_COLOR BUILD_COLOR(MAKE_RGB15(0x00, 0x00, 0x14), 0x01)
#define SAVE_SELECTED_COLOR BUILD_COLOR(MAKE_RGB15(0x1B, 0x00, 0x1B), 0x33)

#define SUMM_TEXT_COLOR BUILD_COLOR_RGBA(0xBA, 0x00, 0xBA, 0xFF)
#define SUMM_VALUE_COLOR BUILD_COLOR(MAKE_RGB15(0x10, 0x00, 0x10), 0x01)
#define LOAD_SAVE_LABEL_COLOR BUILD_COLOR_RGBA(0x7B, 0x83, 0xDE, 0xFF)
#define BOMB_POD_TEXT_COLOR BUILD_COLOR_RGBA(0x00, 0xE0, 0x00, 0xFF)

#define LABEL_LINE_TOP_COLOR BUILD_COLOR_RGBA(0x06, 0x0C, 0xBA, 0xFF)
#define LABEL_LINE_MID_COLOR BUILD_COLOR_RGBA(0x05, 0x0A, 0x9B, 0xFF)
#define LABEL_LINE_BOT_COLOR BUILD_COLOR_RGBA(0x03, 0x06, 0x5D, 0xFF)

#define NO_LIMIT_STROKE_3_COLOR BUILD_COLOR_RGBA(0x02, 0x04, 0x3E, 0xFF)
#define NO_LIMIT_STROKE_2_COLOR BUILD_COLOR_RGBA(0x03, 0x06, 0x5D, 0xFF)
#define NO_LIMIT_STROKE_1_COLOR BUILD_COLOR_RGBA(0x04, 0x08, 0x7C, 0xFF)
#define NO_LIMIT_TEXT_COLOR BUILD_COLOR_RGBA(0x08, 0x10, 0xF8, 0xFF)

#define EMPTY_SLOT_STROKE_3_COLOR BUILD_COLOR_RGBA(0x1F, 0x00, 0x1F, 0xFF)
#define EMPTY_SLOT_STROKE_2_COLOR BUILD_COLOR_RGBA(0x3E, 0x00, 0x3E, 0xFF)
#define EMPTY_SLOT_STROKE_1_COLOR BUILD_COLOR_RGBA(0x5D, 0x00, 0x5D, 0xFF)

#define CARGO_COLOR_TABLE                                     \
	{                                                         \
...
#define ORANGE_STAR_COLOR \
	BUILD_COLOR_RGB(0xFF, 0x8A, 0x00)
...
#define MDL_RECT_COLOR PM_RECT_COLOR
#define MDL_TEXT_COLOR PM_TEXT_COLOR
#define MDL_SHADOW_COLOR BUILD_SHADE_RGBA(0x2E)
