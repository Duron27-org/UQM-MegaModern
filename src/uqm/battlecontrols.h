...
ComputerInputContext* ComputerInputContext_new(uint16_t playerNr);
HumanInputContext* HumanInputContext_new(uint16_t playerNr);
#ifdef NETPLAY
NetworkInputContext* NetworkInputContext_new(uint16_t playerNr);
#endif /* NETPLAY */
