...
{
	return RGB15_to_YUV[(((pix >> (fmt->Rshift + 3)) & 0x1f) << 10) | (((pix >> (fmt->Gshift + 3)) & 0x1f) << 5) | (((pix >> (fmt->Bshift + 3)) & 0x1f))];
}
...
#else
{
	...
	yuv1 = RGB15_to_YUV[(((pix1 >> (fmt->Rshift + 3)) & 0x1f) << 10) | (((pix1 >> (fmt->Gshift + 3)) & 0x1f) << 5) | (((pix1 >> (fmt->Bshift + 3)) & 0x1f))];

	yuv2 = RGB15_to_YUV[(((pix2 >> (fmt->Rshift + 3)) & 0x1f) << 10) | (((pix2 >> (fmt->Gshift + 3)) & 0x1f) << 5) | (((pix2 >> (fmt->Bshift + 3)) & 0x1f))];
				   ...
				   Uint32 pix3, Uint32 pix4)
{
	...
	return
		...
		*/
		((pix1 & 0xfcfcfcfc) >> 2) + ((pix2 & 0xfcfcfcfc) >> 2) + ((pix3 & 0xfcfcfcfc) >> 2) + ((pix4 & 0xfcfcfcfc) >> 2);
}
...
Scale_Blend_31(Uint32 pix1, Uint32 pix2)
{
	/* (pix1 * 3 + pix2) / 4 */
	/*	lower bits can be safely ignored - the error is minimal */
	return ((pix1 & 0xfefefefe) >> 1) + ((pix1 & 0xfcfcfcfc) >> 2) + ((pix2 & 0xfcfcfcfc) >> 2);
}
...
Scale_Blend_211(Uint32 pix1, Uint32 pix2, Uint32 pix3)
{
	/* (pix1 * 2 + pix2 + pix3) / 4 */
	/*	lower bits can be safely ignored - the error is minimal */
	return ((pix1 & 0xfefefefe) >> 1) + ((pix2 & 0xfcfcfcfc) >> 2) + ((pix3 & 0xfcfcfcfc) >> 2);
}
...
Scale_Blend_521(Uint32 pix1, Uint32 pix2, Uint32 pix3)
{
	...
	/*	lower bits can be safely ignored - the error is minimal */
	return ((pix1 & 0xfefefefe) >> 1) + ((pix1 & 0xf8f8f8f8) >> 3) + ((pix2 & 0xfcfcfcfc) >> 2) + ((pix3 & 0xf8f8f8f8) >> 3) + 0x02020202 /* half-error */;
}
...
Scale_Blend_611(Uint32 pix1, Uint32 pix2, Uint32 pix3)
{
	/* (pix1 * 6 + pix2 + pix3) / 8 */
	/*	lower bits can be safely ignored - the error is minimal */
	return ((pix1 & 0xfefefefe) >> 1) + ((pix1 & 0xfcfcfcfc) >> 2) + ((pix2 & 0xf8f8f8f8) >> 3) + ((pix3 & 0xf8f8f8f8) >> 3) + 0x02020202 /* half-error */;
}
...
Scale_Blend_233(Uint32 pix1, Uint32 pix2, Uint32 pix3)
{
	...
	/*	lower bits can be safely ignored - the error is minimal */
	return ((pix1 & 0xfcfcfcfc) >> 2) + ((pix2 & 0xfcfcfcfc) >> 2) + ((pix2 & 0xf8f8f8f8) >> 3) + ((pix3 & 0xfcfcfcfc) >> 2) + ((pix3 & 0xf8f8f8f8) >> 3) + 0x02020202 /* half-error */;
}
...
Scale_Blend_e11(Uint32 pix1, Uint32 pix2, Uint32 pix3)
{
	/* (pix1 * 14 + pix2 + pix3) >> 4 */
	/*	lower bits can be safely ignored - the error is minimal */
	return ((pix1 & 0xfefefefe) >> 1) + ((pix1 & 0xfcfcfcfc) >> 2) + ((pix1 & 0xf8f8f8f8) >> 3) + ((pix2 & 0xf0f0f0f0) >> 4) + ((pix3 & 0xf0f0f0f0) >> 4) + 0x03030303 /* half-error */;
}
