...
typedef HASHTABLE_(Value) * (*HASHTABLE_(CopyFunction))(const HASHTABLE_(Key) *);
...
HASHTABLE_(HashTable) * HASHTABLE_(newHashTable)(HASHTABLE_(HashFunction) hashFunction, HASHTABLE_(EqualFunction) equalFunction, HASHTABLE_(CopyFunction) copyFunction, HASHTABLE_(FreeKeyFunction) freeKeyFunction, HASHTABLE_(FreeValueFunction) freeValueFunction, uio_uint32 initialSize, double minFillQuotient, double maxFillQuotient);
...
HASHTABLE_(Value) * HASHTABLE_(find)(HASHTABLE_(HashTable) * hashTable, const HASHTABLE_(Key) * key);
...
HASHTABLE_(Iterator) * HASHTABLE_(getIterator)(const HASHTABLE_(HashTable) * hashTable);
