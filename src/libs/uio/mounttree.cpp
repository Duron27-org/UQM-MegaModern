...
static uio_MountTree* uio_splitMountTree(uio_MountTree** tree, uio_PathComp* lastComp, int depth);
...
static inline uio_MountTree* uio_MountTree_new(uio_MountTree* subTrees,
											   uio_MountTreeItem* pLocs, uio_MountTree* upTree, uio_PathComp* comps, uio_PathComp* lastComp, uio_MountTree* next);
